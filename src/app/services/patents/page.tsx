...
export const metadata: Metadata = {
  title: "Патентування та реєстрація промислових зразків в Україні",
  description:
    "Професійні послуги з патентування винаходів і корисних моделей та реєстрації промислових зразків в Україні через УКРНОІВІ. Від ₴6 000.",
};
...
const patentTypes = [
  ...
  {
    type: "Свідоцтво на промисловий зразок",
    duration: "25 років",
    price: "₴6 000",
    description: "Реєстрація промислового зразка з отриманням свідоцтва",
    features: [
      "Дизайн продукції",
      "Упаковка товарів",
      "UI/UX інтерфейси",
...
const processSteps = [
  ...
  },
  {
    ...
    description: "Детальний пошук по базах УКРНОІВІ, Espacenet, WIPO для оцінки патентоспроможності.",
  },
  {
    step: "03",
  ...
  },
  {
    ...
    description: "Подаємо заявку до УКРНОІВІ, отримуємо дату пріоритету та номер заявки.",
  },
  {
    step: "05",
    title: "Експертиза",
  ...
  {
    step: "06",
    title: "Отримання охоронного документа",
    description: "Після позитивного рішення отримуємо патент на винахід або корисну модель, або свідоцтво на промисловий зразок.",
  },
];
...
const faq = [
  {
    question: "Що можна запатентувати або зареєструвати?",
    answer: "Патентують технічні рішення (винаходи, корисні моделі), а промислові зразки реєструють зі свідоцтвом. Не підлягають охороні наукові теорії, математичні методи, комп'ютерні програми як такі, методи лікування, бізнес-методи.",
  },
  {
  ...
  },
  {
    ...
    answer: "Корисна модель — 6-12 місяців, промисловий зразок — 6-9 місяців, винахід — 18-24 місяці. Терміни залежать від завантаженості УКРНОІВІ та складності експертизи.",
  },
  {
    ...
    <main className="mx-auto w-full max-w-[1400px] px-6 py-16 sm:px-8">
      ...
      <div className="mb-16">
        ...
        <h1 className="mt-4 text-4xl font-semibold text-tectonic-primary sm:text-5xl">
          Патентування та реєстрація промислових зразків в Україні
        </h1>
        <p className="mt-6 max-w-3xl text-lg text-tectonic-stone-600">
          Професійний супровід патентування винаходів і корисних моделей та реєстрації промислових зразків
          через УКРНОІВІ. Від патентного пошуку до отримання охоронного документа.
        </p>
      </div>
      ...
      <section className="mb-20">
        <Pillar className="mb-10">
          ...
          <p className="mt-2 text-tectonic-stone-600">
            Приклади об'єктів, що підлягають правовій охороні
          </p>
        </Pillar>
      ...
      <section className="mb-20">
        <Pillar className="mb-10">
          <h2 className="text-2xl font-semibold sm:text-3xl">
            Етапи патентування та реєстрації
          </h2>
          <p className="mt-2 text-tectonic-stone-600">
            Від ідеї до отримання охоронного документа
          </p>
        </Pillar>
      ...
      {renderJSONLD([
        ...
        generateProfessionalServiceLD({
          name: "Патентування та реєстрація промислових зразків в Україні",
          description: "Професійний супровід патентування винаходів і корисних моделей та реєстрації промислових зразків через УКРНОІВІ.",
