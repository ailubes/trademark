...
const processSteps = [
  {
    step: "01",
    title: "Базова заявка",
    description: "Подаємо або використовуємо існуючу базову заявку/реєстрацію в УКРНОІВІ.",
  ...
  },
  {
    ...
    description: "Формуємо міжнародну заявку через УКРНОІВІ до WIPO.",
    duration: "3-5 днів",
  },
  {
    step: "04",
...
const faq = [
  ...
  },
  {
    ...
    answer: "Так, для подання міжнародної заявки через УКРНОІВІ потрібна базова українська заявка або реєстрація. Міжнародна заявка має збігатися з базовою за власником, позначенням та переліком товарів/послуг.",
  },
  {
