...
export const metadata: Metadata = {
  ...
  description:
    "Професійна реєстрація торгової марки в Україні через УКРПАТЕНТ. Повний супровід від перевірки до отримання свідоцтва. Від 6 500 грн.",
};
...
const processSteps = [
  {
    ...
    description: "Проводимо пошук по базі УКРПАТЕНТ та TMview для виявлення схожих марок і оцінки ризиків.",
    duration: "1-2 дні",
  },
  {
    step: "02",
  ...
  },
  {
    ...
    description: "УКРПАТЕНТ перевіряє правильність оформлення заявки та сплату мита.",
    duration: "1-2 місяці",
  },
  {
    step: "05",
...
const pricing = [
  ...
  },
  {
    ...
    duration: "8 місяців",
    popular: true,
    description: "Скорочений термін експертизи",
    features: [
      "Все зі Стандарт",
  ...
  },
  {
    ...
    price: "58 200",
    duration: "4 місяці",
    description: "Максимально швидка реєстрація",
    features: [
      "Все з Прискорена",
    ...
    <main className="mx-auto w-full max-w-[1400px] px-6 py-16 sm:px-8">
      ...
      <div className="mb-16 grid gap-12 lg:grid-cols-[1.2fr_1fr]">
        <div>
          ...
          <p className="mt-6 text-lg text-tectonic-stone-600">
            Професійний супровід реєстрації торгової марки через УКРПАТЕНТ.
      ...
      <section className="mb-20">
        <Pillar className="mb-10">
          ...
          <p className="mt-2 text-tectonic-stone-600">
            Оберіть тариф залежно від бажаного терміну реєстрації
          </p>
        </Pillar>
